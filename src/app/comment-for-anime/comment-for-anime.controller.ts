...
class CommentToAnimeRouteControllerClass {
    ...
    add_like = async (req: CommentToAnimeSectionRequestTypes["add_like"], res: ExpressJS.Response) => {
    ...
    /** Deletes Like */
    delete_like = async (req: CommentToAnimeSectionRequestTypes["delete_like"], res: ExpressJS.Response) => {
        const { sessionDto, dto: comment_id } = checkRequestForValidity(req, ["dto", "sessionDto"]);
    ...
    add_dislike = async (req: CommentToAnimeSectionRequestTypes["add_dislike"], res: ExpressJS.Response) => {
    ...
    /** Deletes Dislike */
    delete_dislike = async (req: CommentToAnimeSectionRequestTypes["delete_dislike"], res: ExpressJS.Response) => {
        const { sessionDto, dto: comment_id } = checkRequestForValidity(req, ["dto", "sessionDto"]);
