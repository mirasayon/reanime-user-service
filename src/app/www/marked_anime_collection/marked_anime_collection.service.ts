...
import { ConflictException, NotFoundException } from "@reanime.art/user-service/errors/client-side/exceptions.js";
...
export const MarkedAnimeCollection_Service = new (class MarkedAnimeCollection_Service {
    ...
    get_all_list = async (profile_id: ObjectCuid) => {
    ...
    create_completed = async (profile_id: ObjectCuid, anime_id: number) => {
    ...
    create_planned = async (profile_id: ObjectCuid, anime_id: number) => {
        await this._is_anime_in_collection(profile_id, anime_id);
    ...
    create_abandoned = async (profile_id: ObjectCuid, anime_id: number) => {
        await this._is_anime_in_collection(profile_id, anime_id);
    ...
    create_watching = async (profile_id: ObjectCuid, anime_id: number) => {
        await this._is_anime_in_collection(profile_id, anime_id);
    ...
    delete_completed = async (profile_id: ObjectCuid, anime_id: number) => {
    ...
    delete_planned = async (profile_id: ObjectCuid, anime_id: number) => {
    ...
    delete_abandoned = async (profile_id: ObjectCuid, anime_id: number) => {
    ...
    delete_watching = async (profile_id: ObjectCuid, anime_id: number) => {
