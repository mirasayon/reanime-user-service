...
import { MarkedAnimeCollection_Model as model } from "[www]/anime-bookmark-collection/anime-bookmark-collection.model.js";
...
class _MarkedAnimeCollection_Service {
    ...
    create_completed = async (profile_id: iObjectCuid, anime_id: number): Promise<boolean> => {
    ...
    create_planned = async (profile_id: iObjectCuid, anime_id: number): Promise<boolean> => {
        await this._is_anime_in_collection(profile_id, anime_id);
    ...
    create_abandoned = async (profile_id: iObjectCuid, anime_id: number): Promise<boolean> => {
        await this._is_anime_in_collection(profile_id, anime_id);
    ...
    create_watching = async (profile_id: iObjectCuid, anime_id: number): Promise<boolean> => {
        await this._is_anime_in_collection(profile_id, anime_id);
    ...
    delete_completed = async (profile_id: iObjectCuid, anime_id: number): Promise<boolean> => {
    ...
    delete_planned = async (profile_id: iObjectCuid, anime_id: number): Promise<boolean> => {
    ...
    delete_abandoned = async (profile_id: iObjectCuid, anime_id: number): Promise<boolean> => {
    ...
    delete_watching = async (profile_id: iObjectCuid, anime_id: number): Promise<boolean> => {
