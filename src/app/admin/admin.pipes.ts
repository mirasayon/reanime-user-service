...
import { administratorSectionValidatorSchemas, type AdministratorSectionReqDtos } from "#/shared/request-validator-for-all.routes.js";

export namespace AdministratorSectionRequestTypes {
    export type get_all_users = RequestDtoTypeFactory<AdministratorSectionReqDtos.get_all_users>;
}
