...
export const Favorite_Animes_ReqPipes = new (class Favorite_Animes_ReqPipes {
    explore_likes = validatorMiddlewareFactory<FavoriteAnimesSectionRequestTypes.explore_likes>(favoriteAnimes_schemas.explore_likes);
    explore_dislikes = validatorMiddlewareFactory<FavoriteAnimesSectionRequestTypes.explore_dislikes>(favoriteAnimes_schemas.explore_dislikes);
