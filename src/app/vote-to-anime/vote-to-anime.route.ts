...
export const voteToAnimeSectionRouter = createConfiguredRouter()
    ...
    .get(e.voteToAnime.viewVoteOnAnime, v.view_vote_on_anime, auth, c.view_vote_on_anime)

    .post(e.voteToAnime.addLikeToAnime, v.add_like_to_anime, auth, c.add_like_to_anime)
    .delete(e.voteToAnime.deleteLikeFromAnime, v.delete_like_from_anime, auth, c.delete_like_from_anime)

    .post(e.voteToAnime.addDislikeToAnime, v.add_dislike_to_anime, auth, c.add_dislike_to_anime)
    .delete(e.voteToAnime.deleteDislikeFromAnime, v.delete_dislike_from_anime, auth, c.delete_dislike_from_anime);
