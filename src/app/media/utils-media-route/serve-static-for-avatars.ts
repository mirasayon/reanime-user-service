...
import { Avatar_Image_Allowed_MIME_TYPES } from "#/constants/media-module-config.js";
...
export async function serveAvatarFile(req: ExpressJS.Request, res: ExpressJS.Response, full_path: string) {
