...
export const userAccountSectionRouter = createConfiguredRouter()
    ...
    .patch(e.userAccount.updateUsername, v.update_username, auth, c.update_username)
    ...
    .delete(e.userAccount.terminateSpecificSession, v.terminate_specific_session, auth, c.terminate_specific_session)
