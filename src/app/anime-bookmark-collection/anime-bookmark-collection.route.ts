...
export const animeBookmarkSectionRouter = createConfiguredRouter()
    ...
    .get(e.animeBookmarks.getStatusForAnime(":anime_id"), v.get_for_anime, auth, c.get_for_anime)
    ...
    .post(e.animeBookmarks.createWatching(":anime_id"), v.create_watching, auth, c.create_watching)
    .post(e.animeBookmarks.createAbandoned(":anime_id"), v.create_abandoned, auth, c.create_abandoned)
    .post(e.animeBookmarks.createPlanned(":anime_id"), v.create_planned, auth, c.create_planned)
    .post(e.animeBookmarks.createCompleted(":anime_id"), v.create_completed, auth, c.create_completed)

    .delete(e.animeBookmarks.deleteWatching(":anime_id"), v.delete_watching, auth, c.delete_watching)
    .delete(e.animeBookmarks.deleteAbandoned(":anime_id"), v.delete_abandoned, auth, c.delete_abandoned)
    .delete(e.animeBookmarks.deletePlanned(":anime_id"), v.delete_planned, auth, c.delete_planned)
    .delete(e.animeBookmarks.deleteCompleted(":anime_id"), v.delete_completed, auth, c.delete_completed);
