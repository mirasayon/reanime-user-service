...
export const MarkedAnimeCollection_Controller = new (class MarkedAnimeCollection_Controller {
    ...
    get_for_anime = async (req: MarkedAnimeCollectionRequestTypes.get_for_anime, res: ExpressJS.Response) => {
    ...
    get_list_of_completed = async (req: MarkedAnimeCollectionRequestTypes.get_list_of_completed, res: ExpressJS.Response) => {
        const { sessionDto } = checkRequestForValidity(req, ["sessionDto"]);
    ...
    get_list_of_planned = async (req: MarkedAnimeCollectionRequestTypes.get_list_of_planned, res: ExpressJS.Response) => {
        const { sessionDto } = checkRequestForValidity(req, ["sessionDto"]);
    ...
    get_list_of_abandoned = async (req: MarkedAnimeCollectionRequestTypes.get_list_of_abandoned, res: ExpressJS.Response) => {
        const { sessionDto } = checkRequestForValidity(req, ["sessionDto"]);
    ...
    get_list_of_watching = async (req: MarkedAnimeCollectionRequestTypes.get_list_of_watching, res: ExpressJS.Response) => {
        const { sessionDto } = checkRequestForValidity(req, ["sessionDto"]);
    ...
    create_abandoned = async (req: MarkedAnimeCollectionRequestTypes.create_abandoned, res: ExpressJS.Response) => {
        const { sessionDto, dto } = checkRequestForValidity(req, ["dto", "sessionDto"]);
    ...
    create_planned = async (req: MarkedAnimeCollectionRequestTypes.create_planned, res: ExpressJS.Response) => {
        const { sessionDto, dto } = checkRequestForValidity(req, ["dto", "sessionDto"]);
    ...
    create_completed = async (req: MarkedAnimeCollectionRequestTypes.create_completed, res: ExpressJS.Response) => {
        const { sessionDto, dto } = checkRequestForValidity(req, ["dto", "sessionDto"]);
        const created_planned_to_watch_anime = await service.create_planned(sessionDto.profile_id, dto);
    ...
    create_watching = async (req: MarkedAnimeCollectionRequestTypes.create_watching, res: ExpressJS.Response) => {
        const { sessionDto, dto } = checkRequestForValidity(req, ["dto", "sessionDto"]);
    ...
    /** DELETE */
    delete_completed = async (req: MarkedAnimeCollectionRequestTypes.delete_completed, res: ExpressJS.Response) => {
        const { sessionDto, dto } = checkRequestForValidity(req, ["dto", "sessionDto"]);
    ...
    delete_planned = async (req: MarkedAnimeCollectionRequestTypes.delete_planned, res: ExpressJS.Response) => {
        const { sessionDto, dto } = checkRequestForValidity(req, ["dto", "sessionDto"]);
    ...
    delete_abandoned = async (req: MarkedAnimeCollectionRequestTypes.delete_abandoned, res: ExpressJS.Response) => {
        const { sessionDto, dto } = checkRequestForValidity(req, ["dto", "sessionDto"]);
    ...
    delete_watching = async (req: MarkedAnimeCollectionRequestTypes.delete_watching, res: ExpressJS.Response) => {
        const { sessionDto, dto } = checkRequestForValidity(req, ["dto", "sessionDto"]);
