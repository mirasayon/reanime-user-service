...
class _MarkedAnimeCollection_Service {
    private readonly _is_anime_in_collection = async (profile_id: DbCuidType, anime_id: number) => {
    ...
    get_all_list = async (profile_id: DbCuidType) => {
    ...
    get_list_of_planned = async (profile_id: DbCuidType) => {
        const collection = await model.get_list_of_planned(profile_id);
        return { collection };
    };
    get_list_of_abandoned = async (profile_id: DbCuidType) => {
        const collection = await model.get_list_of_abandoned(profile_id);
        return { collection };
    };
    get_list_of_watching = async (profile_id: DbCuidType) => {
        const collection = await model.get_list_of_watching(profile_id);
        return collection;
    };

    create_completed = async (profile_id: DbCuidType, anime_id: number): Promise<boolean> => {
        await this._is_anime_in_collection(profile_id, anime_id);
        const created_completed_anime = await model.create_1_completed_by_profile_id(profile_id, anime_id);
        return !!created_completed_anime;
    };
    create_planned = async (profile_id: DbCuidType, anime_id: number): Promise<boolean> => {
        await this._is_anime_in_collection(profile_id, anime_id);
    ...
    create_abandoned = async (profile_id: DbCuidType, anime_id: number): Promise<boolean> => {
        await this._is_anime_in_collection(profile_id, anime_id);
    ...
    create_watching = async (profile_id: DbCuidType, anime_id: number): Promise<boolean> => {
        await this._is_anime_in_collection(profile_id, anime_id);
    ...
    delete_completed = async (profile_id: DbCuidType, anime_id: number): Promise<boolean> => {
    ...
    delete_planned = async (profile_id: DbCuidType, anime_id: number): Promise<boolean> => {
    ...
    delete_abandoned = async (profile_id: DbCuidType, anime_id: number): Promise<boolean> => {
    ...
    delete_watching = async (profile_id: DbCuidType, anime_id: number): Promise<boolean> => {
